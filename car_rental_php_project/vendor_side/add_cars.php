...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("
        INSERT INTO cars (cat_id, vendor_id, vehicle_name, vehicle_number, rc_number, insurance_policy_number, fuel_type, seating_capacity, ac_status, gear_type, vehicle_image)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt->bind_param(
        "iissssssiss",
    ...
    <header role="banner">
      ...
      <nav role='navigation'>
        <ul class="main">
          ...
          <li class=""><a href="view_users">Add Cars</a></li>
